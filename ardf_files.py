...
def ARDF_get_VOLM(fd, volm_entry):
    ...
    while True:
        ...
        if magic_bytes == 'VCHN':
            ...
            vdat_data.append([num_point, y_coord, x_coord, data_length, channel_index, cut1, cut2, cut3, cut4, meas_data])
    ...
    return [volm_ftoc, volm_ttoc, volm_vdef, x_channel_names, data_channels_names, data_channels_units,voff_data,vset_data,vnam_data,vdat_data,xdat_data]
