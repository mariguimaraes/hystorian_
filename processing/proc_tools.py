...
def initialise_process(filename, process_name, data_folder = 'datasets', selection = None, selection_depth = 0, create_groups = True):
...
# Logs source folder, written name, and shape in attributes
#INPUTS:
## f: open hdf5 file
